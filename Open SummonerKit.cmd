...
if not defined SUMMONERKIT_EXE if exist "%LOCALAPPDATA%\rose_enhanced\Rose Enhanced.exe" set "SUMMONERKIT_EXE=%LOCALAPPDATA%\rose_enhanced\Rose Enhanced.exe"
if not defined SUMMONERKIT_EXE if exist "%SUMMONERKIT_ROOT%apps\desktop\out\@rose-enhanced-desktop-win32-x64\Rose Enhanced.exe" set "SUMMONERKIT_EXE=%SUMMONERKIT_ROOT%apps\desktop\out\@rose-enhanced-desktop-win32-x64\Rose Enhanced.exe"
